...
/// <summary>
/// BetterCacheManager
/// <para>來源：https://blog.darkthread.net/blog/improved-getcachabledata/ </para>
/// <para>來源：https://blog.darkthread.net/blog/cachable-data-object </para>
/// </summary>
public static class BetterCacheManager
{
    ...
    /// <returns>T</returns>
    public static T GetCachableData<T>(
        string key,
        Func<T> callback,
        int cacheMins,
